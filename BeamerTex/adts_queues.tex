...
\begin{column}{0.45\textwidth}
\verb^fixed.c^
\lstinputlisting[style=basicc,linerange={1-32}]{../../ADTs/Queue/Fixed/fixed.c}
\end{column}
...
\begin{column}{0.45\textwidth}
\lstinputlisting[style=basicc,linerange={34-48}]{../../ADTs/Queue/Fixed/fixed.c}
\end{column}
...
\begin{column}{0.45\textwidth}
\verb^specific.h^
\lstinputlisting[style=basicc]{../../ADTs/Queue/Linked/specific.h}
\end{column}
