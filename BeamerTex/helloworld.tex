...
{\scriptsize{\tt Output :}}
\VerbatimInput{../Code/ChapB/arearect.autoout}
\end{column}
...
{\scriptsize{\tt Output :}}
\lstinputlisting[style=basicterm]{../Code/ChapB/chars.autoout}
\end{column}
...
{\scriptsize{\tt Output :}}
\VerbatimInput{../Code/ChapB/floats.autoout}
\end{column}
...
{\scriptsize{\tt Output :}}
\lstinputlisting[style=basicterm]{../Code/ChapB/sums.manout}
\end{column}
\end{columns}
\end{frame}
