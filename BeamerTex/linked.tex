...
\pause
\begin{column}{0.45\textwidth}
\lstinputlisting[style=basicc,linerange={1-33}]{../Code/ChapP/llist.c}
\end{column}
...
\begin{column}{0.45\textwidth}
\lstinputlisting[style=basicc,linerange={35-53},numbers=none]{../Code/ChapP/llist.c}
\end{column}

\pause
\begin{column}{0.45\textwidth}
Searching and Recursive printing:
\lstinputlisting[style=basicc,linerange={55-73},numbers=none]{../Code/ChapP/llist.c}
\end{column}
