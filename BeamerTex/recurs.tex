...
\item This is a form of `tail-end' recursion.
\item Some compilers can optimize for this since the current function can be terminated
without waiting for the next function to return.
\end{itemize}
\end{column}
