...
\begin{column}{0.45\textwidth}
%% _insert()
\lstinputlisting[style=basicc,linerange={149-168}]{../../ADTs/BST/Linked/linked.c}
\end{column}
...
\begin{column}{0.45\textwidth}
%_isin()
\lstinputlisting[style=basicc,linerange={170-185}]{../../ADTs/BST/Linked/linked.c}
\end{column}

\begin{column}{0.45\textwidth}
%_printlisp()
\lstinputlisting[style=basicc,linerange={205-223}]{../../ADTs/BST/Linked/linked.c}
\end{column}
...
\lstinputlisting[style=basicc,linerange={72-86}]{../../ADTs/BST/Realloc/realloc.c}
\end{column}
